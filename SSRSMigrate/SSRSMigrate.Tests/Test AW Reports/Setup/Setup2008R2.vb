...
Public Sub Main()
    ...
    ' Create data sources
    CreateDataSource("AWDataSource", "/SSRSMigrate_AW_Tests/Data Sources", "Data Source=(local);Initial Catalog=AdventureWorks2008")
    CreateDataSource("Test Data Source", "/SSRSMigrate_AW_Tests/Data Sources", "Data Source=(local);Initial Catalog=AdventureWorks2008")

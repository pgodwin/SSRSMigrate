...
Public Sub Main()
    ...
    ' Create data sources
    CreateDataSource("AWDataSource", "/SSRSMigrate_AW_Tests/Data Sources", "Data Source=(local)\SQL2012;Initial Catalog=AdventureWorks2008")
    CreateDataSource("Test Data Source", "/SSRSMigrate_AW_Tests/Data Sources", "Data Source=(local)\SQL2012;Initial Catalog=AdventureWorks2008")
    
    ' Load reports from disk
    Dim companySalesDef As [Byte]() = FileToByteArray("..\2010\Company Sales.rdl")
    Dim salesOrderDetailsDef As [Byte]() = FileToByteArray("..\2010\Sales Order Detail.rdl")
    Dim storeContactsDef As [Byte]() = FileToByteArray("..\2010\Store Contacts.rdl")

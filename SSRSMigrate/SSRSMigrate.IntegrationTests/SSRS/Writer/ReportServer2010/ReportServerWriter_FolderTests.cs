...
{
    /// <summary>
    /// These integration tests will write FolderItems to a ReportingService2010 endpoint.
    ...
    class ReportServerWriter_FolderTests
    {
        ...
        {
            ReportingService2010TestEnvironment.SetupFolderWriterEnvironment(
        ...
        {
            ReportingService2010TestEnvironment.TeardownFolderWriterEnvironment(
                Properties.Settings.Default.ReportServer2008R2WebServiceUrl,
                CredentialCache.DefaultNetworkCredentials,
                outputPath,
                new List<FolderItem> 
